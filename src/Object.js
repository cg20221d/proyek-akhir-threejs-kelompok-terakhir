...
sunMat.map = textureLoader.load("/public/assets/texture/2k_sun.jpg");
...
mercuryMat.map = textureLoader.load("/public/assets/texture/2k_mercury.jpg");
...
venusMat.map = textureLoader.load("/public/assets/texture/2k_venus_atmosphere.jpg");
...
earthMat.map = textureLoader.load("/public/assets/texture/2k_earth_daymap.jpg");
...
marsMat.map = textureLoader.load("/public/assets/texture/2k_mars.jpg");
...
jupiterMat.map = textureLoader.load("/public/assets/texture/2k_jupiter.jpg");
...
saturnMat.map = textureLoader.load("/public/assets/texture/2k_saturn.jpg");
...
saturnRingMat.map = textureLoader.load("/public/assets/texture/2k_saturn_ring_alpha.png");
...
uranusMat.map = textureLoader.load("/public/assets/texture/2k_uranus.jpg");
...
neptuneMat.map = textureLoader.load("/public/assets/texture/2k_neptune.jpg");
