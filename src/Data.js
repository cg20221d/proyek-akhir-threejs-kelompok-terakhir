...
export const marsRotation = 24.077;
export const jupiterRotation = 13.07;
export const saturnRotation = 968;
export const uranusRotation = 6.81;
...
export const marsRevolution = 687;
export const jupiterRevolution = 4333;
export const saturnRevolution = 10759;
export const uranusRevolution = 30687;
...
export const earthRadius = 6.371;
export const marsRadius = 3.3895;
export const jupiterRadius = 69.911;
export const saturnRadius = 58.232;
export const innerRadius = 80;
export const outerRadius = 136;
export const uranusRadius = 25.362;
...
export const marsDistance = 228;
export const jupiterDistance = 778;
export const saturnDistance = 1426.6;
export const uranusDistance = 2870.6;
export const neptuneDistance = 4498;